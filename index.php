...
<body>
    ...
    <form action="traitement.php" id="inscription" method="POST">
        <div id="reservation" class="blocFormulaire">
            ...
            <input type="radio" name="tarifReduit" id="tarifReduitRadio">
            ...
            <section id="pass2joursDate" class="tarifHidden">
                <input type="radio" name="pass2joursChoix" id="choixJour12">
                <label for="choixJour12">Pass pour deux journées du 01/07 au 02/07</label>
                <input type="radio" name="pass2joursChoix" id="choixJour23">
